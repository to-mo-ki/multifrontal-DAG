...
set(CMAKE_Fortran_FLAGS_RELEASE "-qopenmp -ipo -mkl -integer-size 64" CACHE STRING "" FORCE)
set(CMAKE_Fortran_FLAGS_DEBUG "-qopenmp -O0 -traceback -g -debug -check all,nocontiguous,nopointers -integer-size 64 -mkl -warn all" CACHE STRING "" FORCE)
