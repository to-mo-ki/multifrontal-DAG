program array_rearrange_subroutines_test
  ...
  ptr => rh%get_supernode(1, 2); ptr = 1d0
  ptr => rh%get_work(1, 2); ptr = 1d0
  ptr => rh%get_array_ptr(1, 2); ptr = [1d0,2d0,3d0,4d0,5d0]
  ...
  ptr => rh%get_supernode(1, 2); ptr = [1,2,3]
  ptr => rh%get_work(1, 2); ptr = [4,5]
  ptr => rh%get_array_ptr(1, 2); ptr = 0
