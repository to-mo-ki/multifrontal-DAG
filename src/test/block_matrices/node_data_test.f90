program node_data_test
  ...
  call add_test("node=1, index=1", node_data%get_block_size(1, 1), 3)
  call add_test("node=1, index=2", node_data%get_block_size(2, 1), 3)
  call add_test("node=1, index=3", node_data%get_block_size(3, 1), 3)
  call add_test("node=1, index=4", node_data%get_block_size(4, 1), 1)
  call add_test("node=2, index=1", node_data%get_block_size(1, 2), 3)
  call add_test("node=2, index=2", node_data%get_block_size(2, 2), 3)
  call add_test("node=2, index=3", node_data%get_block_size(3, 2), 3)
  call add_test("node=2, index=4", node_data%get_block_size(4, 2), 1)
  call add_test("node=3, index=1", node_data%get_block_size(1, 3), 3)
  call add_test("node=3, index=2", node_data%get_block_size(2, 3), 3)
  call add_test("node=3, index=3", node_data%get_block_size(3, 3), 3)
  call add_test("node=3, index=4", node_data%get_block_size(4, 3), 2)
  call add_test("node=4, index=1", node_data%get_block_size(1, 4), 3)
  call add_test("node=4, index=2", node_data%get_block_size(2, 4), 3)
  call add_test("node=4, index=3", node_data%get_block_size(3, 4), 3)
  call add_test("node=5, index=1", node_data%get_block_size(1, 5), 3)
  call add_test("node=5, index=2", node_data%get_block_size(2, 5), 3)
  call add_test("node=5, index=3", node_data%get_block_size(3, 5), 3)
  call add_test("node=6, index=1", node_data%get_block_size(1, 6), 3)
  call add_test("node=6, index=2", node_data%get_block_size(2, 6), 3)
  call end_tests()
