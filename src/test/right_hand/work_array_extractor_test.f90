program work_array_extractor_test
  ...
  call add_test("index=2", controller%get_ptr(array, 1, 2), [(dble(i), i=1,1)])
  call add_test("index=3", controller%get_ptr(array, 1, 3), [(dble(i), i=2,4)])
  call add_test("index=4", controller%get_ptr(array, 1, 4), [(dble(i), i=5,5)])
  ...
  array = [(dble(i), i=1,array_size)]
  call start_array_tests("get_ptr")
  call add_test("index=3", controller%get_ptr(array, 2, 3), [(dble(i), i=1,3)])
  call add_test("index=4", controller%get_ptr(array, 2, 4), [(dble(i), i=4,4)])
  call end_array_tests()
  ...
  array = [(dble(i), i=1,array_size)]
  call start_array_tests("get_ptr")
  call add_test("index=3", controller%get_ptr(array, 3, 3), [(dble(i), i=1,2)])
  call add_test("index=4", controller%get_ptr(array, 3, 4), [(dble(i), i=3,4)])
  call end_array_tests()
  ...
  array = [(dble(i), i=1,array_size)]
  call start_array_tests("get_ptr")
  call add_test("index=2", controller%get_ptr(array, 4, 2), [(dble(i), i=1,1)])
  call add_test("index=3", controller%get_ptr(array, 4, 3), [(dble(i), i=2,4)])
  call end_array_tests()
  ...
  array = [(dble(i), i=1,array_size)]
  call start_array_tests("get_ptr")
  call add_test("index=2", controller%get_ptr(array, 5, 2), [(dble(i), i=1,3)])
  call add_test("index=3", controller%get_ptr(array, 5, 3), [(dble(i), i=4,6)])
  call end_array_tests()
  ...
  call add_test("index=2", controller%get_ptr(array, 1, 2), [(dble(i), i=3,5)])
  call end_array_tests()
  ...
  array = [(dble(i), i=1,array_size)]
  call start_array_tests("get_ptr")
  call add_test("index=2", controller%get_ptr(array, 2, 2), [(dble(i), i=1,2)])
  call end_array_tests()
