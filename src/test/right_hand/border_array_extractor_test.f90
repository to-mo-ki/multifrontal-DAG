program border_array_extractor_test
  ...
  call add_test("index=2", extractor%get_ptr(array, 1, 2), [(dble(i), i=1,3)])
  ...
  array = [(dble(i), i=1,array_size)]
  call start_array_tests("get_ptr")
  call add_test("index=3", extractor%get_ptr(array, 3, 3), [(dble(i), i=1,3)])
  call end_array_tests()
  ...
  array = [(dble(i), i=1,array_size)]
  call start_array_tests("get_ptr")
  call add_test("index=2", extractor%get_ptr(array, 4, 2), [(dble(i), i=1,3)])
  call end_array_tests()
  ...
  array = [(dble(i), i=1,array_size)]
  call start_array_tests("get_ptr")
  call add_test("index=1", extractor%get_ptr(array, 1, 1), [(dble(i), i=1,4)])
  call end_array_tests()
  ...
  array = [(dble(i), i=1,array_size)]
  call start_array_tests("get_ptr")
  call add_test("index=2", extractor%get_ptr(array, 2, 2), [(dble(i), i=1,3)])
  call end_array_tests()
