program block_arrays_supernode_test
  ...
  ptr => block_arrays%get_ptr(2,1); ptr = 0.0d0
  ptr => block_arrays%get_ptr(2,2); ptr = 0.0d0
  ptr => block_arrays%get_ptr(3,1); ptr = 0.0d0
  ptr => block_arrays%get_ptr(3,2); ptr = 0.0d0

  ptr => block_arrays%get_ptr(1,1); ptr = ptr + 1.0d0
  ptr => block_arrays%get_ptr(2,1); ptr = ptr + 1.0d0
  ptr => block_arrays%get_ptr(2,2); ptr = ptr + 1.0d0
  ptr => block_arrays%get_ptr(3,1); ptr = ptr + 1.0d0
  ptr => block_arrays%get_ptr(3,2); ptr = ptr + 1.0d0
  ...
  ptr => block_arrays%get_ptr(1,1); ptr = 0d0
  ptr => block_arrays%get_ptr(1,2); ptr = 0d0
  ptr => block_arrays%get_ptr(2,1); ptr = 0d0
  ptr => block_arrays%get_ptr(2,2); ptr = 0d0
  ptr => block_arrays%get_ptr(3,1); ptr = 0d0
  ptr => block_arrays%get_ptr(3,2); ptr = 0d0
  ptr => block_arrays%get_ptr(3,3); ptr = 0d0
  ptr => block_arrays%get_ptr(4,1); ptr = 0d0
  ptr => block_arrays%get_ptr(4,2); ptr = 0d0
  ptr => block_arrays%get_ptr(5,1); ptr = 0d0
  ptr => block_arrays%get_ptr(6,1); ptr = 0d0
  ptr => block_arrays%get_ptr(6,2); ptr = 0d0
  
  ptr => block_arrays%get_ptr(1,1); ptr = ptr + 1d0
  ptr => block_arrays%get_ptr(1,2); ptr = ptr + 1d0
  ptr => block_arrays%get_ptr(2,1); ptr = ptr + 1d0
  ptr => block_arrays%get_ptr(2,2); ptr = ptr + 1d0
  ptr => block_arrays%get_ptr(3,1); ptr = ptr + 1d0
  ptr => block_arrays%get_ptr(3,2); ptr = ptr + 1d0
  ptr => block_arrays%get_ptr(3,3); ptr = ptr + 1d0
  ptr => block_arrays%get_ptr(4,1); ptr = ptr + 1d0
  ptr => block_arrays%get_ptr(4,2); ptr = ptr + 1d0
  ptr => block_arrays%get_ptr(5,1); ptr = ptr + 1d0
  ptr => block_arrays%get_ptr(6,1); ptr = ptr + 1d0
  ptr => block_arrays%get_ptr(6,2); ptr = ptr + 1d0
