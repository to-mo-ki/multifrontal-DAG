program supernode_array_extractor_test
  ...
  call add_test("index=1", controller%get_ptr(array, 1, 1), [(dble(i), i=1,3)])
  call add_test("index=2", controller%get_ptr(array, 1, 2), [(dble(i), i=4,5)])
  ...
  array = [(dble(i), i=1,array_size)]
  call start_array_tests("get_ptr")
  call add_test("index=1", controller%get_ptr(array, 2, 1), [(dble(i), i=1,3)])
  call add_test("index=2", controller%get_ptr(array, 2, 2), [(dble(i), i=4,6)])
  call end_array_tests()
  ...
  array = [(dble(i), i=1,array_size)]
  call start_array_tests("get_ptr")
  call add_test("index=1", controller%get_ptr(array, 3, 1), [(dble(i), i=1,3)])
  call add_test("index=2", controller%get_ptr(array, 3, 2), [(dble(i), i=4,6)])
  call add_test("index=3", controller%get_ptr(array, 3, 3), [(dble(i), i=7,7)])
  call end_array_tests()
  ...
  array = [(dble(i), i=1,array_size)]
  call start_array_tests("get_ptr")
  call add_test("index=1", controller%get_ptr(array, 4, 1), [(dble(i), i=1,3)])
  call add_test("index=2", controller%get_ptr(array, 4, 2), [(dble(i), i=4,5)])
  call end_array_tests()
  ...
  array = [(dble(i), i=1,array_size)]
  call start_array_tests("get_ptr")
  call add_test("index=1", controller%get_ptr(array, 5, 1), [(dble(i), i=1,3)])
  call end_array_tests()
  ...
  array = [(dble(i), i=1,array_size)]
  call start_array_tests("get_ptr")
  call add_test("index=1", controller%get_ptr(array, 6, 1), [(dble(i), i=1,3)])
  call add_test("index=2", controller%get_ptr(array, 6, 2), [(dble(i), i=4,6)])
  call end_array_tests()
  ...
  array = [(dble(i), i=1,array_size)]
  call start_array_tests("get_ptr")
  call add_test("index=1", controller%get_ptr(array, 1, 1), [(dble(i), i=1,2)])
  call end_array_tests()
  ...
  array = [(dble(i), i=1,array_size)]
  call start_array_tests("get_ptr")
  call add_test("index=1", controller%get_ptr(array, 2, 1), [(dble(i), i=1,4)])
  call add_test("index=2", controller%get_ptr(array, 2, 2), [(dble(i), i=5,5)])
  call end_array_tests()
