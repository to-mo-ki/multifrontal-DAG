program border_subroutines_test
  ...
  call border_factorize(node_data, factors, 1, 1)
  ...
  call border_solve(node_data, factors, 1, 2, 1)
  ...
  call border_sym_update(node_data, factors, 1, 3, 1)
  call assert_equal_partial_array("sym_update:a33", a33, [1, 3, 4], 3, [-12d0, -18d0, -27d0])
  call border_update(node_data, factors, 1, 2, 3, 1)
