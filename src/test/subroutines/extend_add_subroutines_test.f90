...
contains
  ...
  subroutine test2
    ...
    call extend_add_diag(factors, block_local_index, block_index, 1, 1, 2)
    a => factors%get_matrix_ptr(2,1,1)
    call add_test("(1,1)=>(3,3)", a(9), 11d0)
    call extend_add_ndiag(factors, block_local_index, block_index, 2, 1, 1, 2)
    a => factors%get_matrix_ptr(2,2,1)
    call add_test("(2,1)=>(4,3)", a(3), 21d0)
    call extend_add_ndiag(factors, block_local_index, block_index, 3, 1, 1, 2)
    a => factors%get_matrix_ptr(2,2,1)
    call add_test("(3,1)=>(5,3)", a(6), 31d0)
    call add_test("(4,1)=>(6,3)", a(9), 41d0)
    call extend_add_ndiag(factors, block_local_index, block_index, 4, 1, 1, 2)
    a => factors%get_matrix_ptr(2,3,1)
    call add_test("(5,1)=>(8,3)", a(6), 51d0)
    call extend_add_ndiag(factors, block_local_index, block_index, 5, 1, 1, 2)
    a => factors%get_matrix_ptr(2,3,1)
    call add_test("(6,1)=>(9,3)", a(9), 61d0)
    call extend_add_ndiag(factors, block_local_index, block_index, 6, 1, 1, 2)
    a => factors%get_matrix_ptr(2,4,1)
    call add_test("(7,1)=>(10,3)", a(3), 71d0)
    call extend_add_diag(factors, block_local_index, block_index, 2, 1, 2)
    a => factors%get_matrix_ptr(2,2,2)
    call add_test("(2,2)=>(4,4)", a(1), 22d0)
    call extend_add_ndiag(factors, block_local_index, block_index, 3, 2, 1, 2)
    a => factors%get_matrix_ptr(2,2,2)
    call add_test("(3,2)=>(5,4)", a(4), 32d0)
    call add_test("(4,2)=>(6,4)", a(7), 42d0)
    call extend_add_ndiag(factors, block_local_index, block_index, 4, 2, 1, 2)
    a => factors%get_matrix_ptr(2,3,2)
    call add_test("(5,2)=>(8,4)", a(4), 52d0)
    call extend_add_ndiag(factors, block_local_index, block_index, 5, 2, 1, 2)
    a => factors%get_matrix_ptr(2,3,2)
    call add_test("(6,2)=>(9,4)", a(7), 62d0)
    call extend_add_ndiag(factors, block_local_index, block_index, 6, 2, 1, 2)
    a => factors%get_matrix_ptr(2,4,2)
    call add_test("(7,2)=>(10,4)", a(1), 72d0)
    call extend_add_diag(factors, block_local_index, block_index, 3, 1, 2)
    a => factors%get_matrix_ptr(2,2,2)
    call add_test("(3,3)=>(5,5)", a(5), 33d0)
    call add_test("(4,3)=>(6,5)", a(8), 43d0)
    call add_test("(4,4)=>(6,6)", a(9), 44d0)
    call extend_add_ndiag(factors, block_local_index, block_index, 4, 3, 1, 2)
    a => factors%get_matrix_ptr(2,3,2)
    call add_test("(5,3)=>(8,5)", a(5), 53d0)
    call add_test("(5,4)=>(8,6)", a(6), 54d0)
    call extend_add_ndiag(factors, block_local_index, block_index, 5, 3, 1, 2)
    a => factors%get_matrix_ptr(2,3,2)
    call add_test("(6,3)=>(9,5)", a(8), 63d0)
    call add_test("(6,4)=>(9,6)", a(9), 64d0)
    call extend_add_ndiag(factors, block_local_index, block_index, 6, 3, 1, 2)
    a => factors%get_matrix_ptr(2,4,2)
    call add_test("(7,3)=>(10,5)", a(2), 73d0)
    call add_test("(7,4)=>(10,6)", a(3), 74d0)
    call extend_add_diag(factors, block_local_index, block_index, 4, 1, 2)
    a => factors%get_matrix_ptr(2,3,3)
    call add_test("(5,5)=>(8,8)", a(5), 55d0)
    call extend_add_ndiag(factors, block_local_index, block_index, 5, 4, 1, 2)
    a => factors%get_matrix_ptr(2,3,3)
    call add_test("(6,5)=>(9,8)", a(8), 65d0)
    call extend_add_ndiag(factors, block_local_index, block_index, 6, 4, 1, 2)
    a => factors%get_matrix_ptr(2,4,3)
    call add_test("(7,5)=>(10,8)", a(2), 75d0)
    call extend_add_diag(factors, block_local_index, block_index, 5, 1, 2)
    a => factors%get_matrix_ptr(2,3,3)
    call add_test("(6,6)=>(9,9)", a(9), 66d0)
    call extend_add_ndiag(factors, block_local_index, block_index, 6, 5, 1, 2)
    a => factors%get_matrix_ptr(2,4,3)
    call add_test("(7,6)=>(10,9)", a(3), 76d0)
    call extend_add_diag(factors, block_local_index, block_index, 6, 1, 2)
