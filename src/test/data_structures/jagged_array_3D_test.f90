program jagged_array_3D_test
  ...
  call add_test("(2, 1)", jag_3d%get_array(2, 1), [121, 122, 123])
  call add_test("(3, 1)", jag_3d%get_array(3, 1), [131])
  call add_test("(4, 1)", jag_3d%get_array(4, 1), [141, 142])
  call add_test("(1, 2)", jag_3d%get_array(1, 2), [211, 212])
  call add_test("(2, 2)", jag_3d%get_array(2, 2), [221, 222])
  call add_test("(1, 3)", jag_3d%get_array(1, 3), [311, 312, 313])
  call add_test("(2, 3)", jag_3d%get_array(2, 3), [321, 322, 323])
  call add_test("(3, 3)", jag_3d%get_array(3, 3), [331, 332])
  call add_test("(1, 4)", jag_3d%get_array(1, 4), [411, 412, 413])
  call add_test("(3, 4)", jag_3d%get_array(3, 4), [431, 432, 433, 434])
  ...
  call add_test("(2, 1)", jag_3d%get_num_3d(2, 1), 3)
  call add_test("(3, 1)", jag_3d%get_num_3d(3, 1), 1)
  call add_test("(4, 1)", jag_3d%get_num_3d(4, 1), 2)
  call add_test("(1, 2)", jag_3d%get_num_3d(1, 2), 2)
  call add_test("(2, 2)", jag_3d%get_num_3d(2, 2), 2)
  call add_test("(1, 3)", jag_3d%get_num_3d(1, 3), 3)
  call add_test("(2, 3)", jag_3d%get_num_3d(2, 3), 3)
  call add_test("(3, 3)", jag_3d%get_num_3d(3, 3), 2)
  call add_test("(1, 4)", jag_3d%get_num_3d(1, 4), 3)
  call add_test("(2, 4)", jag_3d%get_num_3d(2, 4), 0)
  call add_test("(3, 4)", jag_3d%get_num_3d(3, 4), 4)
  call end_tests()
