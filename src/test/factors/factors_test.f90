program factors_test
  ...
  ptr => factors%get_supernode(1,1,1); ptr = 0.0d0
  ptr => factors%get_supernode(1,2,1); ptr = 0.0d0
  ptr => factors%get_supernode(2,1,1); ptr = 0.0d0
  ptr => factors%get_supernode(2,2,1); ptr = 0.0d0
  ptr => factors%get_supernode(2,3,1); ptr = 0.0d0
  ptr => factors%get_supernode(2,4,1); ptr = 0.0d0
  ptr => factors%get_supernode(2,2,2); ptr = 0.0d0
  ptr => factors%get_supernode(2,3,2); ptr = 0.0d0
  ptr => factors%get_supernode(2,4,2); ptr = 0.0d0
  ptr => factors%get_supernode(3,1,1); ptr = 0.0d0
  ptr => factors%get_supernode(3,2,1); ptr = 0.0d0
  ptr => factors%get_supernode(3,2,2); ptr = 0.0d0

  ptr => factors%get_border(1,1,1); ptr = 0.0d0
  ptr => factors%get_border(1,2,1); ptr = 0.0d0
  ptr => factors%get_border(2,1,1); ptr = 0.0d0

  ptr => factors%get_work(1,1,1); ptr = 0d0
  ptr => factors%get_work(1,2,1); ptr = 0d0
  ptr => factors%get_work(1,2,2); ptr = 0d0
  ptr => factors%get_work(2,3,3); ptr = 0d0
  ptr => factors%get_work(2,4,3); ptr = 0d0
  ptr => factors%get_work(2,4,4); ptr = 0d0

  ptr => factors%get_matrix(1, 1, 1); ptr = ptr + 1d0
  ptr => factors%get_matrix(1, 2, 1); ptr = ptr + 1d0
  ptr => factors%get_matrix(1, 2, 2); ptr = ptr + 1d0
  ptr => factors%get_matrix(2, 1, 1); ptr = ptr + 1d0
  ptr => factors%get_matrix(2, 2, 1); ptr = ptr + 1d0
  ptr => factors%get_matrix(2, 3, 1); ptr = ptr + 1d0
  ptr => factors%get_matrix(2, 4, 1); ptr = ptr + 1d0
  ptr => factors%get_matrix(2, 2, 2); ptr = ptr + 1d0
  ptr => factors%get_matrix(2, 3, 2); ptr = ptr + 1d0
  ptr => factors%get_matrix(2, 4, 2); ptr = ptr + 1d0
  ptr => factors%get_matrix(2, 3, 3); ptr = ptr + 1d0
  ptr => factors%get_matrix(2, 4, 3); ptr = ptr + 1d0
  ptr => factors%get_matrix(2, 4, 4); ptr = ptr + 1d0
  ptr => factors%get_matrix(3, 1, 1); ptr = ptr + 1d0
  ptr => factors%get_matrix(3, 2, 1); ptr = ptr + 1d0
  ptr => factors%get_matrix(3, 2, 2); ptr = ptr + 1d0
  ...
  ptr => factors%get_supernode(1,1,1); ptr = 0d0
  ptr => factors%get_supernode(1,2,1); ptr = 0d0
  ptr => factors%get_supernode(1,3,1); ptr = 0d0
  ptr => factors%get_supernode(1,4,1); ptr = 0d0
  ptr => factors%get_supernode(1,2,2); ptr = 0d0
  ptr => factors%get_supernode(1,3,2); ptr = 0d0
  ptr => factors%get_supernode(1,4,2); ptr = 0d0
  ptr => factors%get_supernode(2,1,1); ptr = 0d0
  ptr => factors%get_supernode(2,2,1); ptr = 0d0
  ptr => factors%get_supernode(2,3,1); ptr = 0d0
  ptr => factors%get_supernode(2,4,1); ptr = 0d0
  ptr => factors%get_supernode(2,2,2); ptr = 0d0
  ptr => factors%get_supernode(2,3,2); ptr = 0d0
  ptr => factors%get_supernode(2,4,2); ptr = 0d0
  ptr => factors%get_supernode(3,1,1); ptr = 0d0
  ptr => factors%get_supernode(3,2,1); ptr = 0d0
  ptr => factors%get_supernode(3,3,1); ptr = 0d0
  ptr => factors%get_supernode(3,4,1); ptr = 0d0
  ptr => factors%get_supernode(3,2,2); ptr = 0d0
  ptr => factors%get_supernode(3,3,2); ptr = 0d0
  ptr => factors%get_supernode(3,4,2); ptr = 0d0
  ptr => factors%get_supernode(3,3,3); ptr = 0d0
  ptr => factors%get_supernode(3,4,3); ptr = 0d0
  ptr => factors%get_supernode(4,1,1); ptr = 0d0
  ptr => factors%get_supernode(4,2,1); ptr = 0d0
  ptr => factors%get_supernode(4,3,1); ptr = 0d0
  ptr => factors%get_supernode(4,2,2); ptr = 0d0
  ptr => factors%get_supernode(4,3,2); ptr = 0d0
  ptr => factors%get_supernode(5,1,1); ptr = 0d0
  ptr => factors%get_supernode(5,2,1); ptr = 0d0
  ptr => factors%get_supernode(5,3,1); ptr = 0d0
  ptr => factors%get_supernode(6,1,1); ptr = 0d0
  ptr => factors%get_supernode(6,2,1); ptr = 0d0
  ptr => factors%get_supernode(6,2,2); ptr = 0d0

  ptr => factors%get_border(1,2,2); ptr = 0d0
  ptr => factors%get_border(1,3,2); ptr = 0d0
  ptr => factors%get_border(1,4,2); ptr = 0d0
  ptr => factors%get_border(3,3,3); ptr = 0d0
  ptr => factors%get_border(3,4,3); ptr = 0d0
  ptr => factors%get_border(4,2,2); ptr = 0d0
  ptr => factors%get_border(4,3,2); ptr = 0d0

  ptr => factors%get_work(1,2,2); ptr = 0d0
  ptr => factors%get_work(1,3,2); ptr = 0d0
  ptr => factors%get_work(1,4,2); ptr = 0d0
  ptr => factors%get_work(1,3,3); ptr = 0d0
  ptr => factors%get_work(1,4,3); ptr = 0d0
  ptr => factors%get_work(1,4,4); ptr = 0d0
  ptr => factors%get_work(2,3,3); ptr = 0d0
  ptr => factors%get_work(2,4,3); ptr = 0d0
  ptr => factors%get_work(2,4,4); ptr = 0d0
  ptr => factors%get_work(3,3,3); ptr = 0d0
  ptr => factors%get_work(3,4,3); ptr = 0d0
  ptr => factors%get_work(3,4,4); ptr = 0d0
  ptr => factors%get_work(4,2,2); ptr = 0d0
  ptr => factors%get_work(4,3,2); ptr = 0d0
  ptr => factors%get_work(4,3,3); ptr = 0d0
  ptr => factors%get_work(5,2,2); ptr = 0d0
  ptr => factors%get_work(5,3,2); ptr = 0d0
  ptr => factors%get_work(5,3,3); ptr = 0d0

  ptr => factors%get_matrix(1,1,1); ptr = ptr + 1d0
  ptr => factors%get_matrix(1,2,1); ptr = ptr + 1d0
  ptr => factors%get_matrix(1,3,1); ptr = ptr + 1d0
  ptr => factors%get_matrix(1,4,1); ptr = ptr + 1d0
  ptr => factors%get_matrix(1,2,2); ptr = ptr + 1d0
  ptr => factors%get_matrix(1,3,2); ptr = ptr + 1d0
  ptr => factors%get_matrix(1,4,2); ptr = ptr + 1d0
  ptr => factors%get_matrix(1,3,3); ptr = ptr + 1d0
  ptr => factors%get_matrix(1,4,3); ptr = ptr + 1d0
  ptr => factors%get_matrix(1,4,4); ptr = ptr + 1d0
  ptr => factors%get_matrix(2,1,1); ptr = ptr + 1d0
  ptr => factors%get_matrix(2,2,1); ptr = ptr + 1d0
  ptr => factors%get_matrix(2,3,1); ptr = ptr + 1d0
  ptr => factors%get_matrix(2,4,1); ptr = ptr + 1d0
  ...
  ptr => factors%get_matrix(3,1,1); ptr = ptr + 1d0
  ptr => factors%get_matrix(3,2,1); ptr = ptr + 1d0
  ptr => factors%get_matrix(3,3,1); ptr = ptr + 1d0
  ptr => factors%get_matrix(3,4,1); ptr = ptr + 1d0
  ptr => factors%get_matrix(3,2,2); ptr = ptr + 1d0
  ptr => factors%get_matrix(3,3,2); ptr = ptr + 1d0
  ptr => factors%get_matrix(3,4,2); ptr = ptr + 1d0
  ptr => factors%get_matrix(3,3,3); ptr = ptr + 1d0
  ptr => factors%get_matrix(3,4,3); ptr = ptr + 1d0
  ptr => factors%get_matrix(3,4,4); ptr = ptr + 1d0
  ptr => factors%get_matrix(4,1,1); ptr = ptr + 1d0
  ptr => factors%get_matrix(4,2,1); ptr = ptr + 1d0
  ptr => factors%get_matrix(4,3,1); ptr = ptr + 1d0
  ptr => factors%get_matrix(4,2,2); ptr = ptr + 1d0
  ptr => factors%get_matrix(4,3,2); ptr = ptr + 1d0
  ptr => factors%get_matrix(4,3,3); ptr = ptr + 1d0
  ptr => factors%get_matrix(5,1,1); ptr = ptr + 1d0
  ptr => factors%get_matrix(5,2,1); ptr = ptr + 1d0
  ptr => factors%get_matrix(5,3,1); ptr = ptr + 1d0
  ptr => factors%get_matrix(5,2,2); ptr = ptr + 1d0
  ptr => factors%get_matrix(5,3,2); ptr = ptr + 1d0
  ptr => factors%get_matrix(5,3,3); ptr = ptr + 1d0
  ptr => factors%get_matrix(6,1,1); ptr = ptr + 1d0
  ptr => factors%get_matrix(6,2,1); ptr = ptr + 1d0
  ptr => factors%get_matrix(6,2,2); ptr = ptr + 1d0
