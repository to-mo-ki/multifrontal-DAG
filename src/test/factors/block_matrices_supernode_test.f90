program block_matrices_supernode_test
  ...
  ptr => block_matrices%get_ptr(2,3,1); ptr = 0.0d0
  ptr => block_matrices%get_ptr(2,4,1); ptr = 0.0d0
  ptr => block_matrices%get_ptr(2,2,2); ptr = 0.0d0
  ptr => block_matrices%get_ptr(2,3,2); ptr = 0.0d0
  ptr => block_matrices%get_ptr(2,4,2); ptr = 0.0d0
  ptr => block_matrices%get_ptr(3,1,1); ptr = 0.0d0
  ptr => block_matrices%get_ptr(3,2,1); ptr = 0.0d0
  ptr => block_matrices%get_ptr(3,2,2); ptr = 0.0d0

  ptr => block_matrices%get_ptr(1,1,1); ptr = ptr + 1.0d0
  ptr => block_matrices%get_ptr(1,2,1); ptr = ptr + 1.0d0
  ptr => block_matrices%get_ptr(2,1,1); ptr = ptr + 1.0d0
  ptr => block_matrices%get_ptr(2,2,1); ptr = ptr + 1.0d0
  ptr => block_matrices%get_ptr(2,3,1); ptr = ptr + 1.0d0
  ptr => block_matrices%get_ptr(2,4,1); ptr = ptr + 1.0d0
  ptr => block_matrices%get_ptr(2,2,2); ptr = ptr + 1.0d0
  ptr => block_matrices%get_ptr(2,3,2); ptr = ptr + 1.0d0
  ptr => block_matrices%get_ptr(2,4,2); ptr = ptr + 1.0d0
  ptr => block_matrices%get_ptr(3,1,1); ptr = ptr + 1.0d0
  ptr => block_matrices%get_ptr(3,2,1); ptr = ptr + 1.0d0
  ptr => block_matrices%get_ptr(3,2,2); ptr = ptr + 1.0d0
  ...
  ptr => block_matrices%get_ptr(1,1,1); ptr = 0d0
  ptr => block_matrices%get_ptr(1,2,1); ptr = 0d0
  ptr => block_matrices%get_ptr(1,3,1); ptr = 0d0
  ptr => block_matrices%get_ptr(1,4,1); ptr = 0d0
  ptr => block_matrices%get_ptr(1,2,2); ptr = 0d0
  ptr => block_matrices%get_ptr(1,3,2); ptr = 0d0
  ptr => block_matrices%get_ptr(1,4,2); ptr = 0d0
  ptr => block_matrices%get_ptr(2,1,1); ptr = 0d0
  ptr => block_matrices%get_ptr(2,2,1); ptr = 0d0
  ptr => block_matrices%get_ptr(2,3,1); ptr = 0d0
  ptr => block_matrices%get_ptr(2,4,1); ptr = 0d0
  ptr => block_matrices%get_ptr(2,2,2); ptr = 0d0
  ptr => block_matrices%get_ptr(2,3,2); ptr = 0d0
  ptr => block_matrices%get_ptr(2,4,2); ptr = 0d0
  ptr => block_matrices%get_ptr(3,1,1); ptr = 0d0
  ptr => block_matrices%get_ptr(3,2,1); ptr = 0d0
  ptr => block_matrices%get_ptr(3,3,1); ptr = 0d0
  ptr => block_matrices%get_ptr(3,4,1); ptr = 0d0
  ptr => block_matrices%get_ptr(3,2,2); ptr = 0d0
  ptr => block_matrices%get_ptr(3,3,2); ptr = 0d0
  ptr => block_matrices%get_ptr(3,4,2); ptr = 0d0
  ptr => block_matrices%get_ptr(3,3,3); ptr = 0d0
  ptr => block_matrices%get_ptr(3,4,3); ptr = 0d0
  ptr => block_matrices%get_ptr(4,1,1); ptr = 0d0
  ptr => block_matrices%get_ptr(4,2,1); ptr = 0d0
  ptr => block_matrices%get_ptr(4,3,1); ptr = 0d0
  ptr => block_matrices%get_ptr(4,2,2); ptr = 0d0
  ptr => block_matrices%get_ptr(4,3,2); ptr = 0d0
  ptr => block_matrices%get_ptr(5,1,1); ptr = 0d0
  ptr => block_matrices%get_ptr(5,2,1); ptr = 0d0
  ptr => block_matrices%get_ptr(5,3,1); ptr = 0d0
  ptr => block_matrices%get_ptr(6,1,1); ptr = 0d0
  ptr => block_matrices%get_ptr(6,2,1); ptr = 0d0
  ptr => block_matrices%get_ptr(6,2,2); ptr = 0d0

  ptr => block_matrices%get_ptr(1,1,1); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(1,2,1); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(1,3,1); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(1,4,1); ptr = ptr + 1d0
  ...
  ptr => block_matrices%get_ptr(2,3,1); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(2,4,1); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(2,2,2); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(2,3,2); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(2,4,2); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(3,1,1); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(3,2,1); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(3,3,1); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(3,4,1); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(3,2,2); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(3,3,2); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(3,4,2); ptr = ptr + 1d0
  ...
  ptr => block_matrices%get_ptr(4,3,1); ptr = ptr + 1d0
  ...
  ptr => block_matrices%get_ptr(5,3,1); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(6,1,1); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(6,2,1); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(6,2,2); ptr = ptr + 1d0
