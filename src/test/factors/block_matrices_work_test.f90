program block_matrices_work_test
  ...
  ptr => block_matrices%get_ptr(2,3,3); ptr = 0d0
  ptr => block_matrices%get_ptr(2,4,3); ptr = 0d0
  ptr => block_matrices%get_ptr(2,4,4); ptr = 0d0
  ...
  ptr => block_matrices%get_ptr(2,3,3); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(2,4,3); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(2,4,4); ptr = ptr + 1d0
  ...
  ptr => block_matrices%get_ptr(1,3,3); ptr = 0d0
  ptr => block_matrices%get_ptr(1,4,3); ptr = 0d0
  ptr => block_matrices%get_ptr(1,4,4); ptr = 0d0
  ptr => block_matrices%get_ptr(2,3,3); ptr = 0d0
  ptr => block_matrices%get_ptr(2,4,3); ptr = 0d0
  ptr => block_matrices%get_ptr(2,4,4); ptr = 0d0
  ptr => block_matrices%get_ptr(3,3,3); ptr = 0d0
  ptr => block_matrices%get_ptr(3,4,3); ptr = 0d0
  ptr => block_matrices%get_ptr(3,4,4); ptr = 0d0
  ptr => block_matrices%get_ptr(4,2,2); ptr = 0d0
  ptr => block_matrices%get_ptr(4,3,2); ptr = 0d0
  ptr => block_matrices%get_ptr(4,3,3); ptr = 0d0
  ptr => block_matrices%get_ptr(5,2,2); ptr = 0d0
  ptr => block_matrices%get_ptr(5,3,2); ptr = 0d0
  ptr => block_matrices%get_ptr(5,3,3); ptr = 0d0

  ptr => block_matrices%get_ptr(1,2,2); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(1,3,2); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(1,4,2); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(1,3,3); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(1,4,3); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(1,4,4); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(2,3,3); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(2,4,3); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(2,4,4); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(3,3,3); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(3,4,3); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(3,4,4); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(4,2,2); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(4,3,2); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(4,3,3); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(5,2,2); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(5,3,2); ptr = ptr + 1d0
  ptr => block_matrices%get_ptr(5,3,3); ptr = ptr + 1d0
