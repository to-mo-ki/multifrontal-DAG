...
contains
  ...
  subroutine starpu_factorize(node_data, factors, block_local_index, block_local_index_info, parent)
  ...
  subroutine border_factorize2(node_data, factors, node)
    use starpu_rearrange_subroutines_m
    use starpu_border_subroutines_m
    type(node_data_c), pointer :: node_data
    type(starpu_factors_c), pointer :: factors
    integer, intent(in) :: node
    integer :: i, j, k, num_block
  ...
  subroutine extend_add(node_data, factors, block_local_index, block_local_index_info, node, parent_node)
    use starpu_extend_add_subroutines_m
    type(node_data_c), pointer :: node_data
    type(starpu_factors_c), pointer :: factors
    type(jagged_array_cptr_c), pointer :: block_local_index
    type(block_local_index_info_c), pointer :: block_local_index_info
